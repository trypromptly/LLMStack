    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, storage=llmstack.sheets.models.PromptlySheetFiles.select_storage, upload_to=llmstack.sheets.models.PromptlySheetFiles.sheet_upload_to)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='PromptlySheetRunEntry',
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('profile_uuid', models.UUIDField(help_text='The UUID of the owner of the sheet')),
                ('sheet_uuid', models.UUIDField(help_text='The UUID of the sheet')),
                ('data', models.JSONField(blank=True, default={'cells': []}, help_text='The data of the sheet', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='The date and time the run was created')),
            ],
            options={
                'indexes': [models.Index(fields=['profile_uuid'], name='sheets_prom_profile_e1989f_idx'), models.Index(fields=['sheet_uuid'], name='sheets_prom_sheet_u_f6b4ae_idx')],
            },
        ),
        migrations.CreateModel(
            name='PromptlySheet',
            ...
            options={
                'indexes': [models.Index(fields=['profile_uuid'], name='sheets_prom_profile_0445c4_idx')],
            },
        ),
    ]
