...
DEFAULT_GOOGLE_CUSTOM_SEARCH_API_KEY = os.getenv('DEFAULT_GOOGLE_CUSTOM_SEARCH_API_KEY', '')
DEFAULT_GOOGLE_CUSTOM_SEARCH_CX = os.getenv('DEFAULT_GOOGLE_CUSTOM_SEARCH_CX', '')
