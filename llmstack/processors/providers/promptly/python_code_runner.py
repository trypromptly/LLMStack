...
class PythonCodeRunnerInput(ApiProcessorSchema):
    ...
    local_variables: Optional[str] = Field(description="Values for the local variables as a JSON string")
...
class PythonCodeRunner(
    ApiProcessorInterface[PythonCodeRunnerInput, PythonCodeRunnerOutput, PythonCodeRunnerConfiguration]
):
    """
    Python code runner
    """
    ...
    @staticmethod
    def description() -> str:
        return "Run the provided Python code and return the output"
