...
class CohereGenerateAPIProcessorConfiguration(BaseConfiguration):
    ...
    max_tokens: Optional[int] = Field(
        default=20,
        description='Denotes the number of tokens to predict per generation, defaults to 20. See BPE Tokens for more details. Can only be set to 0 if return_likelihoods is set to ALL to get the likelihood of the prompt',
    )
    ...
    temperature: Optional[float] = Field(
        default=0.75,
        description='Defaults to 0.75, min value of 0.0, max value of 5.0. A non-negative float that tunes the degree of randomness in generation. Lower temperatures mean less random generations. See Temperature for more details.',
    )
...
class CohereGenerateAPIProcessor(LLMBaseProcessor[CohereGenerateAPIProcessorInput,
                                 CohereGenerateAPIProcessorOutput, CohereGenerateAPIProcessorConfiguration]):
    @staticmethod
    def name() -> str:
    ...
    def _get_api_headers(self, input: CohereGenerateAPIProcessorInput,
                         configuration: CohereGenerateAPIProcessorConfiguration) -> Dict[str, str]:
        return {
    ...
    def _process(
            ...
            configuration: CohereGenerateAPIProcessorConfiguration) -> CohereGenerateAPIProcessorOutput:
