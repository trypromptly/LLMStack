...
class TestCharacterTextSplitter(unittest.TestCase):
    def test_character_split(self):
        text_data = """
        Mumbai is built on what was once an archipelago of seven islands: Isle of Bombay, Parel, Mazagaon, Mahim, Colaba, Worli, and Old Woman's Island (also known as Little Colaba).[63] It is not exactly known when these islands were first inhabited.
        Pleistocene sediments found along the coastal areas around Kandivali in northern Mumbai suggest that the islands were inhabited since the South Asian Stone Age.[64] Perhaps at the beginning of the Common Era, or possibly earlier,
        they came to be occupied by the Koli fishing community.[65][66]
        ...
        [67] The Kanheri Caves in Borivali were excavated from basalt rock in the first century CE,[68] and served as an important centre of Buddhism in Western India during ancient Times.
        [69] The city then was known as Heptanesia (Ancient Greek: A Cluster of Seven Islands) to the Greek geographer Ptolemy in 150 CE.[70] The Mahakali Caves in Andheri were cut out between the 1st century BCE and the 6th century CE.[71][72]
        """
