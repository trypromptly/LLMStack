...
from common.blocks.data.store.vectorstore.weaviate import WeaviateConfiguration as BaseWeaviateConfiguration
...
class TempWeaviate(Weaviate):
    ...
    def add_content(self, index_name: str, content: str, **kwargs: Any):
        content = content
        document = Document(
            page_content_key=self.CONTENT_KEY, page_content=content, metadata={'source': kwargs.get('source', 'temp')},
        )
