...
from common.promptly.blocks.http import FormBody
...
from common.promptly.blocks.http import RawRequestBody
...
class OpenAIAPIProcessor(BaseProcessor[OpenAIAPIProcessorInput, OpenAIAPIProcessorOutput, OpenAIAPIProcessorConfiguration], Generic[BaseInputType, BaseOutputType, BaseConfigurationType]):
