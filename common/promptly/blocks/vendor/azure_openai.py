...
class AzureOpenAIAPIProcessor(BaseProcessor[AzureOpenAIAPIProcessorInput, AzureOpenAIAPIProcessorOutput, AzureOpenAIAPIProcessorConfiguration], Generic[BaseInputType, BaseOutputType, BaseConfigurationType]):
    @property
