...
from common.utils.utils import retrier
...
class OpenAIEmbeddingsProcessor(BaseProcessor[OpenAIEmbeddingInput, OpenAIEmbeddingOutput, OpenAIEmbeddingConfiguration],  Generic[BaseInputType, BaseOutputType, BaseConfigurationType]):
    ...
    def _process(self, input: OpenAIEmbeddingInput, configuration: OpenAIEmbeddingConfiguration) -> OpenAIEmbeddingOutput:
