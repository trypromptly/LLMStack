...
class HttpAPIError(BaseError):
    code: int
    message: str


class HttpAPIProcessor(BaseProcessor[HttpAPIProcessorInput, HttpAPIProcessorOutput, HttpAPIProcessorConfiguration], Generic[BaseInputType, BaseOutputType, BaseConfigurationType]):
    """
    # HttpAPIProcessor
