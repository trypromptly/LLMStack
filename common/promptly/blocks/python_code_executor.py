# Processor that helps transform data from one format to another.
import ast
import logging
import re
...
class PythonCodeExecutorProcessor(BaseProcessor[PythonCodeExecutorProcessorInput, PythonCodeExecutorProcessorOutput, PythonCodeExecutorProcessorConfiguration], Generic[BaseInputType, BaseOutputType, BaseConfigurationType]):
    """
    ...
    def _process(self,  input: PythonCodeExecutorProcessorInput, configuration: PythonCodeExecutorProcessorConfiguration) -> PythonCodeExecutorProcessorOutput:
        """
