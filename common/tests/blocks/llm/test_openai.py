import unittest 
import os
from common.blocks.llm.openai import OpenAIChatCompletionsAPIProcessor, OpenAICompletionsAPIProcessor, OpenAIImageGenerationsProcessor, OpenAIAudioTranscriptionProcessor, OpenAIAudioTranslationsProcessor
